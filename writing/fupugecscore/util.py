...
def read_asap_dataset():
    ...
    asap_dataset = pd.read_csv(asap_csv_file_path, sep='\t', encoding='latin1')
...
if __name__ == "__main__":
    ...
    # with open("data/train_data/question.txt", "r") as reader:
    ...
    bw = BertWorker()
    read_dataset_into_tfrecord('data/train_data', bw)
