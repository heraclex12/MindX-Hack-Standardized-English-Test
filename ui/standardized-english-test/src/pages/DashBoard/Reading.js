...
class Reading extends Component {
  constructor(props) {
    ...
    const news_info = [
      [
        ...
        'The New York Times',
        'Find breaking news, multimedia, reviews and opinion on politics, business, sports, music, travel, books, jobs, education and education.',
        'nytimes'
      ],
      ...
      [
        ...
        'THE ATLANTIC',
        'Current affairs, politics, and culture. ',
        'atlantic'
      ],
  ...
  getReading(type) {
    ...
    axios
      .get('http://' + hosting + ':' + port + '/api/get_reading/' + type)
      .then((response) => {
        ...
        {news_info.map((n, index) => (
          <CCol xs='12' sm='6' md='4'>
            <CCard>
              ...
              <CCardFooter>
                <CRow>
                  <Button danger style={{ marginLeft: '2%' }}>
                    <b>Follow</b>
                  </Button>
                  <Button danger style={{ marginLeft: '2%' }}>
                    <b>Add to Favorite</b>
  ...
  render() {
    ...
    return (
      <div className='has-bootstrap reading-container'>
          ...
          <CCard className='big-card'>
            ...
            <CCardBody>
              ...
              <Collapse className='collapse-custom'>
                {readings &&
                  readings[news_info[selectedIndex][3]] &&
                  readings[news_info[selectedIndex][3]][0].qa.map((n, idx) => (
                    <Panel header={n[0]}>
